...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-screen bg-gray-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 bg-white rounded-lg shadow-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-blue-600", children: "Hello World" }),
